...
public class POPacMan extends PacmanController {
    ...
    public MOVE getMove(Game game, long timeDue) {
        ...
        Game game_copy = new Game(0);
        game_copy = game.getGameFromInfo(game.getBlankGameInfo());
        /*
        for(int i=0;i<10;i++)
            game_copy.updatePacMan(MOVE.RIGHT);*/
        System.out.println(current + " " + game.getPacmanCurrentNodeIndex()+ " 1 " + game_copy.getPacmanCurrentNodeIndex());
